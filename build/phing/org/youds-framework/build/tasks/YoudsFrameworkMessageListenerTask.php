 ...
 * @version    $Id$
 */
class YoudsFrameworkMessageListenerTask extends YoudsFrameworkListenerTask
{
	public function main()
	{
		...
		if(!$object instanceof YoudsFrameworkIPhingMessageListener) {
			throw new BuildException(sprintf('Cannot add message listener: Object is of type %s which does not implement %s',
				get_class($object), 'YoudsFrameworkIPhingMessageListener'));
		}
