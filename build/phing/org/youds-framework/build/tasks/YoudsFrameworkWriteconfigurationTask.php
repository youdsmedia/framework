...
/**
 * Writes XPath-defined configuration values to an YoudsFramework configuration file.
 *
 * @package    youds
 * @subpackage build
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkWriteconfigurationTask extends YoudsFrameworkTask
{
	protected $file = null;
	protected $path = null;
	...
	public function main()
	{
		...
		$path->registerNamespace('envelope', 'http://youds.com/youds/config/global/envelope/1.0');
		$path->registerNamespace('envelope10', 'http://youds.com/youds/config/global/envelope/1.0');
		$path->registerNamespace('envelope11', 'http://youds.com/youds/config/global/envelope/1.1');
