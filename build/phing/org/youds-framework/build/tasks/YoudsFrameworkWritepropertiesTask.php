 ...
 * @version    $Id$
 */
class YoudsFrameworkWritepropertiesTask extends YoudsFrameworkTask
{
	protected $file = null;
	...
	{
		$property = new YoudsFrameworkPropertyType();
	...
	public function main()
	{
		...
		$properties->store($this->file, 'Automatically-updated properties file ' . 
			'generated by the YoudsFramework write-properties task');
	}
}
