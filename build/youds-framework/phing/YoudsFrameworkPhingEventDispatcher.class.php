 ...
 * @version    $Id$
 */
final class YoudsFrameworkPhingEventDispatcher extends YoudsFrameworkEventDispatcher implements BuildListener
{
	/**
	...
	/**
	 * @var        array An array of YoudsFrameworkIPhingTargetListener instances.
	 */
	protected $targetListeners = array();
	
	/**
	 * @var        array An array of YoudsFrameworkIPhingTaskListener instances.
	 */
	protected $taskListeners = array();
	
	/**
	 * @var        array An array of YoudsFrameworkIPhingMessageListener instances.
	 */
	 ...
	 *
	 * @param      YoudsFrameworkIPhingTargetListener The target listener.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	public function addTargetListener(YoudsFrameworkIPhingTargetListener $listener)
	{
	 ...
	 *
	 * @param      YoudsFrameworkIPhingTaskListener The task listener.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	public function addTaskListener(YoudsFrameworkIPhingTaskListener $listener)
	{
	 ...
	 *
	 * @param      YoudsFrameworkIPhingMessageListener The message listener.
	 *
	 * @author     Noah Fontes <noah.fontes@bitextender.com>
	 * @since      1.0.0
	 */
	public function addMessageListener(YoudsFrameworkIPhingMessageListener $listener)
	{
	...
	{
		$event = new YoudsFrameworkPhingTargetEvent();
	...
	{
		$event = new YoudsFrameworkPhingTaskEvent();
	...
	{
		$event = new YoudsFrameworkPhingMessageEvent();
