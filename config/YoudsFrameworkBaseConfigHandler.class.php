...
/**
 * YoudsFrameworkBaseConfigHandler allows a developer to create a custom formatted
 ...
 * @version    $Id$
 */
abstract class YoudsFrameworkBaseConfigHandler extends YoudsFrameworkParameterHolder
{
	/**
	...
	protected function generate($code, $path = null)
	{
		...
		return sprintf(
			"<?php\n\n// This is a compiled YoudsFramework configuration file\n// Compiled from: %s\n// Generated by: %s\n// Date: %s\n\n%s\n\n?>",
	 ...
	 * @since      0.9.0
	 *
	 * @deprecated Use YoudsFrameworkToolkit::expandDirectives() instead.
	 */
	public static function literalize($value)
	{
		return YoudsFrameworkToolkit::literalize($value);
	}
	...
	{
		return YoudsFrameworkToolkit::expandDirectives($value);
	}
	...
	{
		if(!YoudsFrameworkToolkit::isPathAbsolute($path)) {
			// not an absolute path so we'll prepend to it
			$path = YoudsFrameworkConfig::get('core.app_dir') . '/' . $path;
		}
