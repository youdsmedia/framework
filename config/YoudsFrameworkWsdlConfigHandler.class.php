...
/**
 * YoudsFrameworkWsdlConfigHandler simply writes the given WSDL file to disk.
 *
 * @package    youds
 * @subpackage config
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkWsdlConfigHandler extends YoudsFrameworkXmlConfigHandler
{
	/**
	 ...
	 * @since      0.11.0
	 */
	public function execute(YoudsFrameworkXmlConfigDomDocument $doc)
	{
		$ro = $this->context->getRouting();
		
		$cleanAppName = preg_replace('/\W/', '', YoudsFrameworkConfig::get('core.app_name'));
