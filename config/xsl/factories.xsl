...
>
	<!--xmlns:factories_1_1="http://youds.com/youds/1.1/config/factories"-->
	
	<xsl:output method="xml" version="1.0" encoding="utf-8" indent="yes" />
	
	<xsl:include href="_common.xsl" />
	
	<xsl:variable name="factories_1_0" select="'http://youds.com/youds/config/parts/factories/1.0'" />
	<xsl:variable name="factories_1_1" select="'http://youds.com/youds/config/parts/factories/1.1'" />
