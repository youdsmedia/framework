...
<xsl:stylesheet
	...
	xmlns:module_1_0="http://youds.com/youds/config/parts/module/1.0"
...
>
	...
	<xsl:variable name="module_1_0" select="'http://youds.com/youds/config/parts/module/1.0'" />
	<xsl:variable name="module_1_1" select="'http://youds.com/youds/config/parts/module/1.1'" />
