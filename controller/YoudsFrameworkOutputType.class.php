 ...
 * @version    $Id$
 */
class YoudsFrameworkOutputType extends YoudsFrameworkParameterHolder
{
	/**
	 ...
	 * @since      0.11.0
	 */
	public function initialize(YoudsFrameworkContext $context, array $parameters, $name, array $renderers, $defaultRenderer, array $layouts, $defaultLayout, $exceptionTemplate = null)
	{
	...
	/**
	 * @see        YoudsFrameworkOutputType::getName()
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
	 ...
	 *
	 * @return     YoudsFrameworkRenderer A Renderer instance or null if none defined.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
	public function getRenderer($name = null)
	{
		...
		if(isset($this->renderers[$name])) {
			if($this->renderers[$name]['instance'] === null) {
				...
				if($renderer instanceof YoudsFrameworkIReusableRenderer) {
			...
			throw new YoudsFrameworkException('Unknown renderer "' . $name . '"');
		}
	}
	...
	public function getLayout($name = null)
	{
		...
		if(isset($this->layouts[$name])) {
			...
			throw new YoudsFrameworkException('Unknown layout "' . $name . '"');
		}
	}
