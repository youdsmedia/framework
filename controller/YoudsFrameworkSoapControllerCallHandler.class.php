...
/**
 * YoudsFrameworkSoapControllerCallHandler has the __call overload for the PHP SOAP ext.
 *
 * @package    youds
 ...
 * @version    $Id$
 */
class YoudsFrameworkSoapControllerCallHandler
{
	/**
	 * @var        YoudsFrameworkContext The context.
	 */
	protected $context;
	 ...
	 *
	 * @param      YoudsFrameworkSoapController The SOAP controller to call doDispatch on.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
	public function __construct(YoudsFrameworkContext $context)
	{
