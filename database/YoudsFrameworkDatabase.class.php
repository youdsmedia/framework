...
/**
 * YoudsFrameworkDatabase is a base abstraction class that allows you to setup any type
 ...
 * @version    $Id$
 */
abstract class YoudsFrameworkDatabase extends YoudsFrameworkParameterHolder
{
	/**
	 * @var        YoudsFrameworkDatabaseManager An YoudsFrameworkDatabaseManager instance.
	 */
	 ...
	 *
	 * @return     YoudsFrameworkDatabaseManager A Database Manager instance.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
