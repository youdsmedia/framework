 ...
 * its own, or in conjunction with YoudsFrameworkDoctrine2ormDatabase (which in turn does
 * not require a separate YoudsFrameworkDoctrine2dbalDatabase).
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkDoctrine2dbalDatabase extends YoudsFrameworkDoctrine2Database
{
	/**
	...
	public function connect()
	{
		...
		try {
			...
			throw new YoudsFrameworkDatabaseException(sprintf("Failed to create connection '%s':\n\n%s" . $this->getName(), $e->getMessage()), 0, $e);
		}
	}
}
