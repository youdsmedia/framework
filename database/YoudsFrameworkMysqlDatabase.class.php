...
/**
 * YoudsFrameworkMysqlDatabase provides connectivity for the MySQL brand database.
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkMysqlDatabase extends YoudsFrameworkDatabase
{
	/**
	...
	protected function connect()
	{
		...
		switch($method) {
			...
			default:
				...
				$error = 'Invalid YoudsFrameworkMySQLDatabase parameter retrieval method ' .
						 '"%s"';
		...
		if($this->connection === false) {
			...
			$error = 'Failed to create a YoudsFrameworkMySQLDatabase connection';
			throw new YoudsFrameworkDatabaseException($error);
		}
		...
		if($database !== null && !@mysql_select_db($database, $this->connection)) {
			...
			$error = 'Failed to select YoudsFrameworkMySQLDatabase "%s"';
