...
/**
 * YoudsFrameworkMysqliDatabase provides advanced connectivity for the MySQL database.
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkMysqliDatabase extends YoudsFrameworkMysqlDatabase
{
	/**
	...
	protected function connect()
	{
		...
		switch($method) {
			...
			default:
				...
				$error = 'Invalid YoudsFrameworkMySQLiDatabase parameter retrieval method ' .
						 '"%s"';
		...
		if($this->connection === false) {
			...
			$error = 'Failed to create a YoudsFrameworkMySQLiDatabase connection';
			throw new YoudsFrameworkDatabaseException($error);
		}
		...
		if($database !== null && !$this->connection->select_db($database)) {
			...
			$error = 'Failed to select YoudsFrameworkMySQLiDatabase "%s"';
