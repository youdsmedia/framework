...
/**
 * YoudsFrameworkPostgresqlDatabase provides connectivity for the PostgreSQL brand 
 * database.
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkPostgresqlDatabase extends YoudsFrameworkDatabase
{
	/**
	...
	protected function connect()
	{
		...
		switch($method) {
			...
			default:
				...
				$error = 'Invalid YoudsFrameworkPostgreSQLDatabase parameter retrieval method "%s"';
		...
		if($this->connection === false) {
			...
			$error = 'Failed to create a YoudsFrameworkPostgreSQLDatabase connection';
