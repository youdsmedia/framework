...
/**
 * YoudsFrameworkZendclouddocumentserviceDatabase provides connectivity to databases
 ...
 * @version    $Id$
 */
class YoudsFrameworkZendclouddocumentserviceDatabase extends YoudsFrameworkDatabase
{
	/**
	...
	public function connect()
	{
		try {
			...
			throw new YoudsFrameworkDatabaseException(sprintf("Caught exception of type %s while creating adapter instance; details:\n\n%s", get_class($e), $e->getMessage()), 0, $e);
		}
	}
	...
	public function listDocuments(array $options = null)
	{
		if(!$this->hasParameter('collection')) {
			throw new YoudsFrameworkDatabaseException('Convenience functions require configuration parameter "collection".');
		}
