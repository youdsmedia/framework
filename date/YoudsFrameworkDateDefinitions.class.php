...
/**
 * Field definitions for the YoudsFrameworkCalendar and day of week and months constants
 *
 * Based on ICU:
 ...
 * @version    $Id$
 */
final class YoudsFrameworkDateDefinitions
{
	/** 
	 * Field number indicating the era, e.g., {@link YoudsFrameworkGregorianCalendar::AD} 
	 * or {@link YoudsFrameworkGregorianCalendar::BC} in the Gregorian (Julian) calendar.
	 * 
	 ...
	 * {@link YoudsFrameworkCalendar::getFirstDayOfWeek()} or
	 * {@link YoudsFrameworkCalendar::getMinimalDaysInFirstWeek()}. 
	 ...
	 * @since      0.11.0
	 */
	const DAY_OF_MONTH            = YoudsFrameworkDateDefinitions::DATE;
