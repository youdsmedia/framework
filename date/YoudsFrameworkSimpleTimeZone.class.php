 ...
 * @version    $Id$
 */
class YoudsFrameworkSimpleTimeZone extends YoudsFrameworkTimeZone
{
	/**
	 ...
	 *
	 * @param      YoudsFrameworkTimeZone The SimpleTimeZone object to be compared with.
	 * 
	 ...
	 * @since      0.11.0
	 */
	function __is_equal(YoudsFrameworkTimeZone $that)
	{
		return ($this === $that ||
						(get_class($this) == get_class($that) &&
							YoudsFrameworkTimeZone::__is_equal($that) &&
	 ...
	 * Overloaded.
	 * 
	 * @see        YoudsFrameworkSimpleTimeZone::constructorOIS()
	 * @see        YoudsFrameworkSimpleTimeZone::constructorOISIIIIIIII()
	 * @see        YoudsFrameworkSimpleTimeZone::constructorOISIIIIIIIII()
	 * @see        YoudsFrameworkSimpleTimeZone::constructorOISIIIIIIIIIII()
	 * 
	 ...
	 *
	 * @param      YoudsFrameworkTranslationManager The translation Manager
	 ...
	 * @since      0.11.0
	 */
	protected function constructorOIS(YoudsFrameworkTranslationManager $tm, $rawOffsetGMT, $id)
	{
		...
		$this->dstSavings = YoudsFrameworkDateDefinitions::MILLIS_PER_HOUR;
	}
	 ...
	 * @since      0.11.0
	 */
	protected function constructorOISIIIIIIII(YoudsFrameworkTranslationManager $tm, $rawOffsetGMT, $id, $savingsStartMonth, $savingsStartDay, $savingsStartDayOfWeek, $savingsStartTime, $savingsEndMonth,  $savingsEndDay, $savingsEndDayOfWeek, $savingsEndTime)
	{
		parent::__construct($tm, $id);
		$this->construct($rawOffsetGMT, $savingsStartMonth, $savingsStartDay, $savingsStartDayOfWeek, $savingsStartTime, self::WALL_TIME, $savingsEndMonth, $savingsEndDay, $savingsEndDayOfWeek, $savingsEndTime, self::WALL_TIME, YoudsFrameworkDateDefinitions::MILLIS_PER_HOUR);
	}
	 ...
	 * @since      0.11.0
	 */
	protected function constructorOISIIIIIIIII(YoudsFrameworkTranslationManager $tm, $rawOffsetGMT, $id, $savingsStartMonth, $savingsStartDay, $savingsStartDayOfWeek, $savingsStartTime, $savingsEndMonth, $savingsEndDay, $savingsEndDayOfWeek, $savingsEndTime, $savingsDST)
	{
		parent::__construct($tm, $id);
	 ...
	 * @since      0.11.0
	 */
	protected function constructorOISIIIIIIIIIII(YoudsFrameworkTranslationManager $tm, $rawOffsetGMT, $id, $savingsStartMonth, $savingsStartDay, $savingsStartDayOfWeek, $savingsStartTime, $savingsStartTimeMode, $savingsEndMonth, $savingsEndDay, $savingsEndDayOfWeek, $savingsEndTime, $savingsEndTimeMode, $savingsDST)
	{
		parent::__construct($tm, $id);
	 ...
	 * Overloaded.
	 * 
	 * @see        YoudsFrameworkSimpleTimeZone::setStartRuleIIII()
	 * @see        YoudsFrameworkSimpleTimeZone::setStartRuleIIIIF()
	 * @see        YoudsFrameworkSimpleTimeZone::setStartRuleIII()
	 * @see        YoudsFrameworkSimpleTimeZone::setStartRuleIIIF()
	 * @see        YoudsFrameworkSimpleTimeZone::setStartRuleIIIIB()
	 * @see        YoudsFrameworkSimpleTimeZone::setStartRuleIIIIFB()
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 * @since      0.11.0
	 ...
	 * <code>
	 *  setStartRule(YoudsFrameworkDateDefinitions::APRIL, 1, YoudsFrameworkDateDefinitions::SUNDAY,
	 *  2*60*60*1000);
	 * </code>
	 ...
	 * Overloaded.
	 * 
	 * @see        YoudsFrameworkSimpleTimeZone::setEndRuleIIII()
	 * @see        YoudsFrameworkSimpleTimeZone::setEndRuleIIIIF()
	 * @see        YoudsFrameworkSimpleTimeZone::setEndRuleIII()
	 * @see        YoudsFrameworkSimpleTimeZone::setEndRuleIIIF()
	 * @see        YoudsFrameworkSimpleTimeZone::setEndRuleIIIIB()
	 * @see        YoudsFrameworkSimpleTimeZone::setEndRuleIIIIFB()
	 * 
	 * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
	 * @author     The ICU Project
	 * @since      0.11.0
	 ...
	 * Overloaded.
	 * 
	 * @see        YoudsFrameworkSimpleTimeZone::getOffsetIIIIII()
	 * @see        YoudsFrameworkSimpleTimeZone::getOffsetIIIIIII()
	 * @see        YoudsFrameworkSimpleTimeZone::getOffsetIIIIIIII()
	 * 
	 * @author     Dominik del Bondio <dominik.del.bondio@bitextender.com>
	 * @author     The ICU Project
	 * @since      0.11.0
	...
	public function getOffsetIIIIII($era, $year, $month, $day, $dayOfWeek, $millis)
	{
		...
		if($month < YoudsFrameworkDateDefinitions::JANUARY || $month > YoudsFrameworkDateDefinitions::DECEMBER) {
				throw new InvalidArgumentException('Month out of range');
				return 0;
		}

		return $this->getOffsetIIIIIII($era, $year, $month, $day, $dayOfWeek, $millis, YoudsFrameworkCalendarGrego::monthLength($year, $month));
	}
	...
	public function getOffsetIIIIIII($era, $year, $month, $day, $dayOfWeek, $millis, $monthLength)
	{
		...
		return $this->getOffsetIIIIIIII($era, $year, $month, $day, $dayOfWeek, $millis, YoudsFrameworkCalendarGrego::monthLength($year, $month), YoudsFrameworkCalendarGrego::previousMonthLength($year, $month));
	}
	...
	{
		if(($era != YoudsFrameworkGregorianCalendar::AD && $era != YoudsFrameworkGregorianCalendar::BC)
				|| $month < YoudsFrameworkDateDefinitions::JANUARY
				|| $month > YoudsFrameworkDateDefinitions::DECEMBER
				|| $day < 1
				|| $day > $monthLength
				|| $dayOfWeek < YoudsFrameworkDateDefinitions::SUNDAY
				|| $dayOfWeek > YoudsFrameworkDateDefinitions::SATURDAY
				|| $millis < 0
				|| $millis >= YoudsFrameworkDateDefinitions::MILLIS_PER_DAY
				|| $monthLength < 28
				|| $monthLength > 31
				|| $prevMonthLength < 28
				|| $prevMonthLength > 31) {
		...
		if(!$this->useDaylight || $year < $this->startYear || $era != YoudsFrameworkGregorianCalendar::AD) 
			return $result;
	 ...
	 * 
	 * @param      YoudsFrameworkTimeZone The TimeZone object to be compared with
	 * 
	 ...
	 * @since      0.11.0
	 */
	public function hasSameRules(YoudsFrameworkTimeZone $other)
	{
		if($this === $other) {
			return true;
		}
...
*/
	...
	private static function compareToRule($month, $monthLen, $prevMonthLen, $dayOfMonth, $dayOfWeek, $millis, $millisDelta, $ruleMode, $ruleMonth,  $ruleDayOfWeek, $ruleDay, $ruleMillis)
	{
		...
		$millis += $millisDelta;
		while($millis >= YoudsFrameworkDateDefinitions::MILLIS_PER_DAY) {
			$millis -= YoudsFrameworkDateDefinitions::MILLIS_PER_DAY;
			++$dayOfMonth;
	...
	private function decodeStartRule() 
	{
		...
		if($this->startDay != 0) {
			if($this->startMonth < YoudsFrameworkDateDefinitions::JANUARY || $this->startMonth > YoudsFrameworkDateDefinitions::DECEMBER) {
				throw new InvalidArgumentException('startMonth out of range');
			}
			if($this->startTime < 0 || $this->startTime > YoudsFrameworkDateDefinitions::MILLIS_PER_DAY || $this->startTimeMode < self::WALL_TIME || $this->startTimeMode > self::UTC_TIME) {
			...
			if($this->startDayOfWeek == 0) {
				...
				if($this->startDayOfWeek > YoudsFrameworkDateDefinitions::SATURDAY) {
			...
			if($this->startMode == self::DOW_IN_MONTH_MODE) {
				if($this->startDay < -5 || $this->startDay > 5) {
					throw new YoudsFrameworkException('startDay out of range');
				}
	 ...
	 *
	 * @see        YoudsFrameworkSimpleTimeZone::decodeStartRule
	 * 
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @author     The ICU Project
	 * @since      0.11.0
	...
	private function decodeEndRule() 
	{
		...
		if($this->endDay != 0) {
			if($this->endMonth < YoudsFrameworkDateDefinitions::JANUARY || $this->endMonth > YoudsFrameworkDateDefinitions::DECEMBER) {
				throw new InvalidArgumentException('endMonth out of range');
			}
			if($this->endTime < 0 || $this->endTime > YoudsFrameworkDateDefinitions::MILLIS_PER_DAY || $this->endTimeMode < self::WALL_TIME || $this->endTimeMode > self::UTC_TIME) {
			...
			if($this->endDayOfWeek == 0) {
				...
				if($this->endDayOfWeek > YoudsFrameworkDateDefinitions::SATURDAY) {
