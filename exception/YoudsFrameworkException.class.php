...
/**
 * YoudsFrameworkException is the base class for all YoudsFramework related exceptions and
 ...
 * @version    $Id$
 */
class YoudsFrameworkException extends Exception
{
	/**
	 ...
	 * @param      YoudsFrameworkResponse The response instance.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.9.0
	 *
	 * @deprecated Superseded by YoudsFrameworkException::render()
	 */
	public static function printStackTrace(Exception $e, YoudsFrameworkContext $context = null, YoudsFrameworkExecutionContainer $container = null)
	{
	 ...
	 * array([object YoudsFrameworkFilter], 'baz' => array(1, 2), 'log' => [resource stream])
	 *
	 ...
	 * @since      1.0.0
	 */
	public static function render(Exception $e, YoudsFrameworkContext $context = null, YoudsFrameworkExecutionContainer $container = null)
	{
		...
		if($context !== null && YoudsFrameworkConfig::get('exception.templates.' . $context->getName()) !== null) {
			// a template was set for this context
			include(YoudsFrameworkConfig::get('exception.templates.' . $context->getName()));
			exit($exitCode);
		}
		
		// include default exception template
		include(YoudsFrameworkConfig::get('exception.default_template'));
