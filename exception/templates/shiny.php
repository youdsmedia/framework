...
} elseif(isset($container) && ($rd = $container->getRequestData()) !== null && $rd instanceof YoudsFrameworkIHeadersRequestDataHolder && $rd->hasHeader('User-Agent')) {
	$ua = $rd->getHeader('User-Agent');
} elseif(isset($context) && ($rq = $context->getRequest()) !== null && !$rq->isLocked() && ($rd = $rq->getRequestData()) !== null && $rd instanceof YoudsFrameworkIHeadersRequestDataHolder) {
	$ua = $rd->getHeader('User-Agent');
}
...
?>
		<section>
			...
			<div class="container">
				<dl>
					<dt>YoudsFramework:</dt>
					<dd><?php echo htmlspecialchars(YoudsFrameworkConfig::get('youds.version')); ?></dd>
					<dt>PHP:</dt>
