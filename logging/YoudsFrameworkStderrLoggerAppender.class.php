...
/**
 * YoudsFrameworkStderrLoggerAppender appends an YoudsFrameworkLoggerMessages to the stderr.
 *
 * @package    youds
 * @subpackage logging
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkStderrLoggerAppender extends YoudsFrameworkStreamLoggerAppender
{
	/**
