 ...
 * @version    $Id$
 */
class YoudsFrameworkPhpRenderer extends YoudsFrameworkRenderer implements YoudsFrameworkIReusableRenderer
{
	/**
	...
	/**
	 * @var        YoudsFrameworkTemplateLayer Temporary storage for the template layer,
