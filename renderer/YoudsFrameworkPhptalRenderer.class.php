 ...
 * @version    $Id$
 */
class YoudsFrameworkPhptalRenderer extends YoudsFrameworkRenderer
{
	/**
	...
	{
		$phptalPhpCodeDestination = YoudsFrameworkConfig::get('core.cache_dir') . DIRECTORY_SEPARATOR . YoudsFrameworkPhptalRenderer::COMPILE_DIR . DIRECTORY_SEPARATOR . YoudsFrameworkPhptalRenderer::COMPILE_SUBDIR . DIRECTORY_SEPARATOR;
		...
		YoudsFrameworkToolkit::mkdir($phptalPhpCodeDestination, fileperms(YoudsFrameworkConfig::get('core.cache_dir')), true);
		...
		if(version_compare(PHPTAL_VERSION, '1.2', 'ge')) {
		  ...
		  trigger_error('Support for PHPTAL versions older than 1.2 is deprecated and will be removed in YoudsFramework 1.2.', E_USER_DEPRECATED);
		}
