...
/**
 * YoudsFrameworkConsoleRequest provides support for console-only request information
 ...
 * @version    $Id$
 */
class YoudsFrameworkConsoleRequest extends YoudsFrameworkRequest
{
	/**
	...
	public function __construct()
	{
		...
		$this->setParameters(array(
			'request_data_holder_class' => 'YoudsFrameworkConsoleRequestDataHolder',
		));
	}
