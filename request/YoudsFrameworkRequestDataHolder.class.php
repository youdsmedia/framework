...
/**
 * YoudsFrameworkRequestDataHolder provides methods for retrieving client request 
 ...
 * @version    $Id$
 */
class YoudsFrameworkRequestDataHolder extends YoudsFrameworkParameterHolder implements YoudsFrameworkIParametersRequestDataHolder
{
	/**
	...
	final protected function registerSource($name, array &$holder)
	{
		...
		$this->sourceNames[$name] = YoudsFrameworkInflector::singularize($name);
	}
	 ...
	 * @since      0.11.0
	 */
	public function merge(YoudsFrameworkRequestDataHolder $other)
	{
