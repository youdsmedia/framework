...
/**
 * YoudsFrameworkSecureWebRequest provides additional support for HTTPS client requests
 ...
 * @since      0.10.0.0
 *
 * @deprecated To be removed in YoudsFramework 1.1
 *
 * @version    $Id$
 */
class YoudsFrameworkSecureWebRequest extends YoudsFrameworkWebRequest {
