...
/**
 * YoudsFrameworkSoapRequestDataHolder provides methods for retrieving client request 
 ...
 * @version    $Id$
 */
class YoudsFrameworkSoapRequestDataHolder extends YoudsFrameworkWebserviceRequestDataHolder implements YoudsFrameworkIHeadersRequestDataHolder
{
	/**
