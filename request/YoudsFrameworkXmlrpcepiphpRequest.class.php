...
/**
 * YoudsFrameworkXmlrpcepiphpRequest is an implementation for handling XMLRPC Web
 ...
 * @version    $Id$
 */
class YoudsFrameworkXmlrpcepiphpRequest extends YoudsFrameworkWebserviceRequest
{
	/**
