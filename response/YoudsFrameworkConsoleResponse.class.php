...
/**
 * YoudsFrameworkConsoleResponse handles command line responses.
 *
 * @package    youds
 * @subpackage response
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkConsoleResponse extends YoudsFrameworkResponse
{
	/**
	 ...
	 * It gets registered as a shutdown function in YoudsFrameworkConsoleResponse::send().
	 *
	 * @author     David Zülke <david.zuelke@bitextender.com>
	 * @since      1.0.0
	 */
