...
/**
 * YoudsFrameworkResponse handles the output and other stuff sent back to the client.
 *
 * @package    youds
 * @subpackage response
 *
 ...
 * @version    $Id$
 */
abstract class YoudsFrameworkResponse extends YoudsFrameworkAttributeHolder
{
	/**
	...
	/**
	 * @var        YoudsFrameworkOutputType The output type of this response.
	 */
	...
	/**
	 * Retrieve the YoudsFrameworkContext instance this Response object belongs to.
	 *
	 ...
	 *
	 * @return     YoudsFrameworkOutputType The Output Type instance associated with.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.1
	 */
	 ...
	 *
	 * @param      YoudsFrameworkOutputType The Output Type instance to associate with.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.1
	 */
	 ...
	 * @since      0.11.0
	 */
	abstract public function send(YoudsFrameworkOutputType $outputType = null);
