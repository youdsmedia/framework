...
/**
 * YoudsFrameworkSoapResponse handles SOAP Web Service responses using the PHP SOAP ext.
 *
 * @package    youds
 * @subpackage response
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkSoapResponse extends YoudsFrameworkResponse
{
	/**
	...
	public function merge(YoudsFrameworkResponse $otherResponse)
	{
		...
		if($otherResponse instanceof YoudsFrameworkSoapResponse) {
	...
	/**
	 * @see        YoudsFrameworkResponse::isMutable()
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
