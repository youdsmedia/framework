...
/**
 * YoudsFrameworkXmlrpcepiphpResponse handles XMLRPC Web Service responses using the
 ...
 * @version    $Id$
 */
class YoudsFrameworkXmlrpcepiphpResponse extends YoudsFrameworkResponse
{
	/**
	 ...
	 *
	 * @see        YoudsFrameworkResponse::setContent()
	 *
