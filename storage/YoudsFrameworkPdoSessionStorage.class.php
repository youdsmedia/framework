 ...
 * @version    $Id$
 */
class YoudsFrameworkPdoSessionStorage extends YoudsFrameworkSessionStorage
{
	/**
	 ...
	 *                  exception is thrown.
	 *
	 * @throws     <b>YoudsFrameworkDatabaseException</b> If the session cannot be
	 *                                           destroyed.
	 *
	 * @author     Sean Kerr <skerr@mojavi.org>
	 * @author     Veikko Mäkinen <mail@veikkomakinen.com>
	...
	public function sessionDestroy($id)
	{
		...
		try {
			...
			throw new YoudsFrameworkDatabaseException($error, 0, $e);
		}
	}
	 ...
	 *                  exception is thrown.
	 *
	 * @throws     <b>YoudsFrameworkDatabaseException</b> If old sessions cannot be
	 *                                           cleaned.
	 *
	 * @author     Sean Kerr <skerr@mojavi.org>
	 * @author     Veikko Mäkinen <mail@veikkomakinen.com>
	 ...
	 *                  is thrown.
	 *
	 * @throws     <b>YoudsFrameworkDatabaseException</b> If a connection with the database
	 ...
	 *                  thrown.
	 *
	 * @throws     <b>YoudsFrameworkDatabaseException</b> If the session cannot be read.
	 *
	 * @author     Sean Kerr <skerr@mojavi.org>
	 * @author     Veikko Mäkinen <mail@veikkomakinen.com>
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 ...
	 *                  is thrown.
	 *
	 * @throws     <b>YoudsFrameworkDatabaseException</b> If session data cannot be
	 *                                           written.
	 *
	 * @author     Sean Kerr <skerr@mojavi.org>
	 * @author     Veikko Mäkinen <mail@veikkomakinen.com>
