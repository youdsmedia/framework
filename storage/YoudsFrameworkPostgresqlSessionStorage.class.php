 ...
 * @version    $Id$
 */
class YoudsFrameworkPostgresqlSessionStorage extends YoudsFrameworkSessionStorage
{
	/**
	 ...
	 *                  is thrown.
	 *
	 * @throws     <b>YoudsFrameworkDatabaseException</b> If the session data cannot be 
	 *                                           written.
	 *
	 * @author     Sean Kerr <skerr@mojavi.org>
	 * @since      0.9.0
