...
/**
 * YoudsFrameworkSessionStorage is the interface used by YoudsFramework to store session data from
 ...
 * # <b>session_name</b>            - [YoudsFramework] - The name of the session.
 ...
 * @version    $Id$
 */
class YoudsFrameworkSessionStorage extends YoudsFrameworkStorage
{
	/**
	 * Starts the session.
	...
	public function startup()
	{
		...
		session_name($this->getParameter('session_name', 'YoudsFramework'));
		...
		if($sessionId === '' || ($staticSessionId && $sessionId !== $staticSessionId)) {
			...
			if($secure === null && $request instanceof YoudsFrameworkWebRequest) {
