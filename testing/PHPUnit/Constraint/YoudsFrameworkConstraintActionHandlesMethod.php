 ...
 * @version    $Id$
 */
class YoudsFrameworkConstraintActionHandlesMethod extends YoudsFrameworkBaseConstraintBecausePhpunitSucksAtBackwardsCompatibility
{
	/**
	 * @var        YoudsFrameworkAction The Action instance.
	 */
	 ...
	 * Class constructor.
	 * 
	 * @param      YoudsFrameworkAction Instance of the Action to test.
	 * @param      bool        Whether generic execute methods should be accepted.
	 * 
	 * @author     Felix Gilcher <felix.gilcher@bitextender.com>
	 * @since      1.0.0
	 */
	public function __construct(YoudsFrameworkAction $actionInstance, $acceptGeneric = true)
	{
