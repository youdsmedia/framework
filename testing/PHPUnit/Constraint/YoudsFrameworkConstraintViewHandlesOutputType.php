 ...
 * @version    $Id$
 */
class YoudsFrameworkConstraintViewHandlesOutputType extends YoudsFrameworkBaseConstraintBecausePhpunitSucksAtBackwardsCompatibility
{
	/**
	 * @var        YoudsFrameworkView The View instance.
	 */
	 ...
	 * constructor
	 * 
	 * @param      YoudsFrameworkView Instance of the View to test
	 * @param      bool      Whether generic execute methods should be accepted.
	 * 
	 * @author     Felix Gilcher <felix.gilcher@bitextender.com>
	 * @since      1.0.0
	 */
	public function __construct(YoudsFrameworkView $viewInstance, $acceptGeneric = false)
	{
