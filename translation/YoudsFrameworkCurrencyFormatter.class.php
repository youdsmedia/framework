 ...
 * @version    $Id$
 */
class YoudsFrameworkCurrencyFormatter extends YoudsFrameworkDecimalFormatter implements YoudsFrameworkITranslator
{
	/**
	...
	public function initialize(YoudsFrameworkContext $context, array $parameters = array())
	{
		...
		if(!empty($parameters['rounding_mode'])) {
			...
			$this->setRoundingMode(YoudsFrameworkDecimalFormatter::ROUND_NONE);
		}
	...
	public function getCurrencySymbol()
	{
		...
		switch($this->currencyType) {
			case YoudsFrameworkDecimalFormatter::CURRENCY_SYMBOL:
				return $symbol;
			case YoudsFrameworkDecimalFormatter::CURRENCY_CODE:
				return $code;
			case YoudsFrameworkDecimalFormatter::CURRENCY_NAME:
				return $name;
		}
