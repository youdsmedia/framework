 ...
 * @version    $Id$
 */
class YoudsFrameworkDateFormatter extends YoudsFrameworkDateFormat implements YoudsFrameworkITranslator
{
	/**
	 * @var        YoudsFrameworkLocale An YoudsFrameworkLocale instance.
	 */
	...
	public function translate($message, $domain, YoudsFrameworkLocale $locale = null)
	{
		...
		return $fmt->format($message, YoudsFrameworkCalendar::GREGORIAN, $locale);
	}
	...
	public function localeChanged($newLocale)
	{
		...
		if(is_array($this->customFormat)) {
			$format = YoudsFrameworkToolkit::getValueByKeyList($this->customFormat, YoudsFrameworkLocale::getLookupPath($this->locale->getIdentifier()));
	 ...
	 * @param      YoudsFrameworkLocale The locale to use for resolving.
