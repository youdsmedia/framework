...
/**
 * YoudsFrameworkGettextMoReader reads a .mo file into an array.
 * 
 * @package    youds
 ...
 * @version    $Id$
 */
final class YoudsFrameworkGettextMoReader
{
	/**
	...
	public static function readFile($filePath)
	{
		...
		if($fileId == 'de120495') {
			...
			throw new YoudsFrameworkException('Unknown .mo file header. Was: ' . $fileId);
		}
