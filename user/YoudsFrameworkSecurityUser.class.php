...
/**
 * YoudsFrameworkBasicSecurityUser will handle any type of data as a credential.
 *
 * @package    youds
 * @subpackage user
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkSecurityUser extends YoudsFrameworkUser implements YoudsFrameworkISecurityUser
{
	// +-----------------------------------------------------------------------+
	// | CONSTANTS                                                             |
	// +-----------------------------------------------------------------------+
	 ...
	 */
	const AUTH_NAMESPACE = 'org.youds.user.BasicSecurityUser.authenticated';

	/**
	 * The namespace under which credentials will be stored.
	 */
	const CREDENTIAL_NAMESPACE = 'org.youds.user.BasicSecurityUser.credentials';
