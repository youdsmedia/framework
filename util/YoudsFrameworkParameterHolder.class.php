...
/**
 * YoudsFrameworkParameterHolder provides a base class for managing parameters.
 *
 * @package    youds
 * @subpackage util
 *
 ...
 * @version    $Id$
 */
class YoudsFrameworkParameterHolder
{
	/**
	...
	public function &getParameter($name, $default = null)
	{
		...
		try {
			return YoudsFrameworkArrayPathDefinition::getValue($name, $this->parameters, $default);
	...
	{
		return YoudsFrameworkArrayPathDefinition::getFlatKeyNames($this->parameters);
	}
	...
	public function hasParameter($name)
	{
		...
		try {
			return YoudsFrameworkArrayPathDefinition::hasValue($name, $this->parameters);
		} catch(InvalidArgumentException $e) {
			return false;
		}
	}
	...
	public function &removeParameter($name)
	{
		...
		$retval = null;
		try {
			$retval =& YoudsFrameworkArrayPathDefinition::unsetValue($name, $this->parameters);
		} catch(InvalidArgumentException $e) {
		}
		return $retval;
	}
