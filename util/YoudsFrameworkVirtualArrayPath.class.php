...
/**
 * YoudsFrameworkPath implements handling of virtual paths
 * 
 ...
 * @version    $Id$
 */
class YoudsFrameworkVirtualArrayPath
{
	/**
	...
	public function __construct($path)
	{
		...
		$parts = YoudsFrameworkArrayPathDefinition::getPartsFromPath($path);
	...
	{
		return YoudsFrameworkArrayPathDefinition::hasValue($this->parts, $array);
	}
	...
	{
		return YoudsFrameworkArrayPathDefinition::getValue($this->parts, $array, $default);
	}
	...
	{
		YoudsFrameworkArrayPathDefinition::setValue($this->parts, $array, $value);
	}
