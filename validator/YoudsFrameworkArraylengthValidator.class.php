...
/**
 * YoudsFrameworkArraylengthValidator verifies the length (count()) constraints for an array
 *
 * Parameters:
 ...
 * @version    $id$
 */
class YoudsFrameworkArraylengthValidator extends YoudsFrameworkValidator
{
	/**
	 * Returns whether all arguments are set in the validation input parameters.
	 * Set means anything but empty string.
	 * Different to YoudsFrameworkValidator::checkAllArgumentsSet() in that it will not
	...
	{
		// copied from YoudsFrameworkValidator::checkAllArgumentsSet()
		...
		foreach($this->getArguments() as $argument) {
			...
			// as for example YoudsFrameworkWebRequestDataHolder::isFileValueEmpty() returns false if the element is not an instance of YoudsFrameworkUploadedFile
