...
/**
 * YoudsFrameworkInArrayValidator verifies whether an input is one of a set of values
 * 
 * Parameters:
 ...
 * @version    $Id$
 */
class YoudsFrameworkInarrayValidator extends YoudsFrameworkValidator
{
	/**
	 * Validates the input.
	 * 
