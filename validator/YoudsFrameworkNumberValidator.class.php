...
/**
 * YoudsFrameworkNumberValidator verifies that a parameter is a number and allows you to
 ...
 * @version    $Id$
 */
class YoudsFrameworkNumberValidator extends YoudsFrameworkValidator
{
	/**
	 * Validates the input
	 * 
	...
	protected function validate()
	{
		...
		if(!is_int($value) && !is_float($value)) {
			$locale = null;
			if(YoudsFrameworkConfig::get('core.use_translation') && !$this->getParameter('no_locale', false)) {
			...
			$parsedValue = YoudsFrameworkDecimalFormatter::parse($value, $locale, $hasExtraChars);
		} else {
			$parsedValue = $value;
		}
