...
/**
 * YoudsFrameworkRegexValidator allows you to match a value against a regular expression
 * pattern.
 * 
 * Parameters:
 ...
 * @version    $Id$
 */
class YoudsFrameworkRegexValidator extends YoudsFrameworkValidator
{
	/**
	 * Validates the input.
	 * 
