...
/**
 * YoudsFrameworkValidationError stores an error message and the fields of an error.
 *
 * @package    youds
 ...
 * @version    $Id$
 */
class YoudsFrameworkValidationError
{
	/**
	...
	/**
	 * @var        YoudsFrameworkValidationIncident The incident in which this error 
	 *                                     occurred.
	 */
	...
	public function __construct($message, $name, array $arguments)
	{
		...
		foreach($arguments as $argument) {
			if(!($argument instanceof YoudsFrameworkValidationArgument)) {
				$argument = new YoudsFrameworkValidationArgument($argument);
			}
	 ...
	 * @since      0.11.0
	 */
	public function setIncident(YoudsFrameworkValidationIncident $incident)
	{
	 ...
	 *
	 * @return     YoudsFrameworkValidationIncident The incident.
	 *
	 * @author     Dominik del Bondio <ddb@bitxtender.com>
	 * @since      0.11.0
	 */
	 ...
	 * @since      1.0.0
	 */
	public function hasArgument(YoudsFrameworkValidationArgument $argument)
	{
	...
	{
		return $this->hasArgument(new YoudsFrameworkValidationArgument($fieldname));
	}
