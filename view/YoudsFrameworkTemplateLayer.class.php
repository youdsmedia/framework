 ...
 * @version    $Id$
 */
abstract class YoudsFrameworkTemplateLayer extends YoudsFrameworkParameterHolder
{
	/**
	 * @var        YoudsFrameworkContext The current Context.
	 */
	protected $context = null;
	
	/**
	 * @var        YoudsFrameworkRenderer The Renderer instance to be used for this layer.
	 */
	 ...
	 *
	 * @param      YoudsFrameworkRenderer An optional renderer instance that will be used
	 ...
	 * @since      0.11.0
	 */
	public function execute(YoudsFrameworkRenderer $renderer = null, array &$attributes = array(), array &$moreAssigns = array())
	{
		$output = array();
		...
		if(!($renderer instanceof YoudsFrameworkRenderer)) {
			throw new YoudsFrameworkException('No renderer has been set or given.');
		}
	 ...
	 *
	 * @param      YoudsFrameworkRenderer A renderer instance.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
	public function setRenderer(YoudsFrameworkRenderer $renderer)
	{
	 ...
	 *
	 * @return     YoudsFrameworkRenderer A renderer instance.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
	 ...
	 * @param      YoudsFrameworkExecutionContainer The slot's execution container.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
	public function setSlot($name, YoudsFrameworkExecutionContainer $c)
	{
		$this->slots[$name] = $c;
	}
	 ...
	 * @param      string The name of the slot.
	 *
	 * @return     YoudsFrameworkExecutionContainer The slot's execution container.
	 *
	 * @author     David Zülke <dz@bitxtender.com>
	 * @since      0.11.0
	 */
